    ...
    <form onSubmit={handleSubmit} className="max-w-lg space-y-4">
        ...
        {isEditing && (
          <div className="flex items-center gap-3">
            {nav.prev ? (
              ...
              <span className="text-gray-300 text-sm">&larr; Anterior</span>
            )}
            {nav.next ? (
              <a
              ...
              <span className="text-gray-300 text-sm">Siguiente &rarr;</span>
            )}
          </div>
        )}
      </div>
      ...
      <div className="flex gap-8 pt-2">
        <label className="flex items-center gap-3 cursor-pointer">
          <span className="text-sm text-gray-600">Mostrar en Cumpleaños</span>
          <button
            type="button"
            role="switch"
        ...
        <label className="flex items-center gap-3 cursor-pointer">
          <span className="text-sm text-gray-600">Mostrar en Aniversarios</span>
          <button
            type="button"
            role="switch"
